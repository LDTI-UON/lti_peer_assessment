...
$ppage_output .= "<label for='filter_submitted2'>Students not submitted: </label>".form_radio(array('name' => 'filter_submitted', 'id' => 'filter_submitted2', 'value' => 'ns', 'checked' => $selected2))."</label></p>";
