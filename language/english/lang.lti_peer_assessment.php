...
$lang = array(
	'lti_peer_assessment_module_name' =>
	'LTI Peer Assessment',

	'lti_peer_assessment_module_description' =>
	'Provides Peer Assessment features, this module requires the Learning Tools Integration (LTI) module.',

	'module_home' => 'LTI Peer Assessment Home',

	'consumers_title' => 'Registered LTI Consumers',

	'consumer_name' => 'Consumer Name',
	'no_consumers_registered' => 'No consumers are registered',

	'add_consumer' => 'Add LTI Consumer',

	'add_consumer_name' => 'Consumer Display Name',
	'add_consumer_key' => 'Consumer Key',
	'add_consumer_secret' => 'Consumer Secret',
	'add_url_segment' => 'URL Segment',
	'delete_consumers' => 'Delete Selected LTI Consumer(s)',
	'error_html_in_resource_link_description' => 'You have HTML in your resource link description. Please check your LMS\s documentation for how to setup an LTI link.',
	 ...
	 'consumer_deleted' => 'Consumers successfully deleted.',
	 'consumer_delete_question' => 'Are you sure you want to delete this/these consumer(s)?',
	 'not_launch_request' => 'This does not appear to be an LTI launch request.',
	 'no_students_in_this_context' => 'There are no students currently registered for BOLD services in this course',
